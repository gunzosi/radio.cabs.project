        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceCities_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverPersonalImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DriverLicenseImage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DriverImages_Drivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceCities_CompanyId",
                table: "ServiceCities",
                column: "CompanyId");
        }
